  ...
  config = mkIf (cfg.desktop.enable || enabledServerSecrets) (mkMerge [
    ...
    (mkIf cfg.desktop.enable {
      age.secrets = {
        ...
        "sany-gpg-subkeys.priv.age" =
          {
            file = "${mysecrets}/sany-gpg-subkeys-2024-01-27.priv.age.age";
          }
          // noaccess;
      ...
      environment.etc = {
        ...
        "agenix/sany-gpg-subkeys.priv.age" = {
          source = config.age.secrets."sany-gpg-subkeys.priv.age".path;
          mode = "0000";
        };
